...
class Cifar100:
    ...
    def initialize(self):
        ...
        for train_data, train_label in zip(self.train_data, self.train_labels):
            ...
            # train_data_r = train_data[:1024*4].reshape(64, 64)
            # train_data_g = train_data[1024*4:2048*4].reshape(64, 64)
            # train_data_b = train_data[2048*4:].reshape(64, 64)
        ...
        for test_data, test_label in zip(self.test_data, self.test_labels):
            ...
            # test_data_r = test_data[:1024*4].reshape(64, 64)
            # test_data_g = test_data[1024*4:2048*4].reshape(64, 64)
            # test_data_b = test_data[2048*4:].reshape(64, 64)
...
if __name__ == "__main__":
    cifar = Cifar100()
    # 这个是测试用
    print(len(cifar.each_train_groups[99]))
